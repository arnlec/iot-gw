...
class BridgeFactoryTest(unittest.TestCase):
    ...
    def test_gcp_mqtt_bridge(self):
        ...
        adapter = bridge_adapter_factory.create(config)
        self.assertIsNotNone(adapter)

    def test_missing_adapter_property(self):
        self.assertRaises(RuntimeError,bridge_adapter_factory.create,{})

    def test_unknown_adapter(self):
        self.assertRaises(RuntimeError,bridge_adapter_factory.create,{'adapter':'unknown'})    
